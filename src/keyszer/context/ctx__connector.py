...
if SESSION_TYPE.casefold() in ['x11', 'xorg']:
    try:
        ...
        debug(f'CTX: Window attribute module: X11/Xorg.', ctx="--")
    ...
    try:
        ...
        debug(f'CTX: Window attribute module: Wayland+GNOME D-Bus to shell extension.', ctx="--")
    ...
    try:
        ...
        debug(f'CTX: Window attribute module: Wayland+sway D-Bus.', ctx="--")
