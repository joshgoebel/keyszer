...
conditional_multipurpose_modmap(lambda wm_class, device_name: device_name.startswith("Microsoft"), {
...
keymap(re.compile("Firefox|Google-chrome"), {
...
# when(
#     lambda window: window.klass != "Emacs", 
#     lambda device: device == "Apple, Inc Apple Keyboard",
#     keymap(re.compile("Zeal"), {
...
keymap(lambda wm_class: wm_class not in ("Emacs", "URxvt"), {
    # Cursor
