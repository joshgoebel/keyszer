...
conditional(
    lambda ctx: re.compile(r'Emacs').search(ctx.wm_class),
    modmap("Emacs",{
...
conditional(
    lambda ctx: ctx.device_name.startswith("Microsoft"),
...
conditional(
    lambda ctx: re.compile("Firefox|Google-chrome").search(ctx.wm_class),
...
conditional(
    lambda ctx: re.compile("Zeal").search(ctx.wm_class),
    keymap("Zeal", {
...
conditional(
    lambda ctx: ctx.wm_class not in ("Emacs", "URxvt"),
